...
plt.plot(list_min_SNR[:,12], list_min_SNR[:,2], label = f'New SNR')
plt.plot(list_min_SNR[:,12], list_min_SNR[:,3], label = f'Old SNR.', linestyle='dashed')
plt.scatter(list_min_SNR[:,12], list_min_SNR[:,2], label = f'New SNR', c="blue")
plt.scatter(list_min_SNR[:,12], list_min_SNR[:,3], label = f'Old SNR.', c="orange")
plt.title(f'Indistinguishability SNR. Q=1.5, s1x=s1y=s1z=0.5, s2z=0.7.')
...
plt.figure(figsize=(12, 5))
plt.plot(list_min_SNR[:,12], list_min_SNR[:,0], label = f'1-FF')
plt.plot(list_min_SNR[:,12], list_min_SNR[:,1], label = f'1-Overlap.', linestyle='dashed')
plt.scatter(list_min_SNR[:,12], list_min_SNR[:,0], label = f'1-FF', c="blue")
plt.scatter(list_min_SNR[:,12], list_min_SNR[:,1], label = f'1-Overlap.', c="orange")
plt.title(f'1-FF and 1-Overlap. Q=1.5, s1x=s1y=s1z=0.5, s2z=0.7.')
plt.xlabel('Polarization')
...
plt.figure(figsize=(12, 5))
plt.plot(list_min_SNR[:,12], list_Testing[:,1], label = f'Time')
plt.scatter(list_min_SNR[:,12], list_Testing[:,1], label = f'Time')
plt.title(f'1-FF and 1-Overlap. Q=1.5, s1x=s1y=s1z=0.5, s2z=0.7.')
plt.xlabel('Polarization')
plt.ylabel('Time (s)')
plt.legend()
plt.savefig('./Graphics/Time.png', bbox_inches='tight') 
plt.savefig('./Graphics/Time.pdf', bbox_inches='tight') 
plt.show() 